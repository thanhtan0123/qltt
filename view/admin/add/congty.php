                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Thêm công ty tuyển thực tập</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a href="congty.php" ><input class="btn btn-warning mb-3 disabled" type="reset" value="Thêm công ty" disabled=""></a>
                            ...
                            <div class="card-body">
                                        ...
                                        <form action="#" method="post" enctype="multipart/form-data">
                                           ...
                                           <div class="input-group mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">Khu vực</span>
                                                </div>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <textarea class="form-control" aria-label="With textarea" name="chitietcongty"></textarea>
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
    ...
    <?php 
                                              ...
                                              switch ($_POST['submit1']) {
                                                case 'Xác nhận':
                                                  ...
                                                  {
                                                    $t->addcongty($username,$password,$tencongty,$hinh,$diachi,$khuvuc,$chitietcongty,$lienhe);
                                                    break;
                                                  }
                                              }
                                           ?>
