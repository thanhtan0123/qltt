                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Thêm giảng viên</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a href="" ><input class="btn btn-warning mb-3 disabled" type="reset" value="Thêm giảng viên" disabled=""></a>
                                
                                <a href="../delete/giangvien.php"><input class="btn btn-danger mb-3" type="reset" value="Xóa giảng viên"></a>
                            ...
                            <div class="card-body">
                                        ...
                                        <form action="#" method="post" enctype="multipart/form-data">
                                           ...
                                           <div class="input-group mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">Tên giảng viên</span>
                                                </div>
                                                <input type="text" name="tengiangvien" class="form-control">
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">Hình đại diện</span>
                                                </div>
                                                <input type="file" name="hinh" class="form-control">
                                            </div>
                                           <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">Liên hệ</span>
                                                </div>
                                                <input type="text" name="lienhe" class="form-control">
                                            </div>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1">Khoa</span>
                                                </div>
                                                <select name="idkhoaselect" id="">
                                                    <option selected hidden disabled=""  >-- Chọn -- </option>
                                                    <?php 
                                                        $t->khoaGV("select * from khoa");
                                                     ?>
                                                </select>
                                            </div>
     ...
     <?php 
                                              ...
                                              switch ($_POST['submit1']) {
                                                case 'Xác nhận':
                                                  ...
                                                  {
                                                    $t->addgiangvien($username,$password,$tengiangvien,$hinh,$idkhoa,$lienhe);
                                                    break;
                                                  }
                                              }
                                           ?>
