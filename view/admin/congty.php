                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li><a href="#"><i class="ti-settings"></i><span>Chỉnh sửa</span></a>
                                                <ul class="collapse">
                                                    ...
                                                    <li><a href="update/giangvien.php"><i class="ti-close"></i><span>Sửa</span></a></a></li>
                                                </ul>
                                            </li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Quản lí công ty</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">Danh sách công ty đang tuyển dụng    <span style="margin-left: 600px"><a href="#heyyou" class="ml-auto"> <i class="ti-hand-point-right" style="margin-right: 5px"></i> Danh sách công ty trong hệ thống</a></span></h4>
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <tbody>
                                        <?php 
                                            $t->AdSV1("select  * from congty a join nganhcongtytuyendung b on a.id=b.idcty join nganhdaotao c on b.idnganh=c.iddt join khoa d on c.idkhoa=d.idnganh")
                                         ?>     
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="delete/congty.php"><input class="btn btn-danger mb-3" type="reset" value="Xóa công ty"></a>
                                ...
                                <div class="data-tables">
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            <?php $t->AdSV2("select * from congty") ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
