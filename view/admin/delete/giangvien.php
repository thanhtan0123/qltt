                    ...
                    <div class="col-12 mt-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="../delete/congty.php"><input class="btn btn-danger mb-3" type="reset" value="Xóa giảng viên" disabled=""></a>
                                <h4 class="header-title">Danh sách giảng viên trong hệ thống</h4>
                                <div class="data-tables">
                                    ...
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            <?php $t->AdGV3("select * from giangvien"); ?>
                                        </tbody>
