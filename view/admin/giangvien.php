            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <a href="add/giangvien.php" ><input class="btn btn-warning mb-3" type="reset" value="Thêm giảng viên"></a>
                                
                                <a href="delete/giangvien.php"><input class="btn btn-danger mb-3" type="reset" value="Xóa giảng viên"></a>
                                <h4 class="header-title">Danh sách giảng viên</h4>
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="text-center">
                                        ...
                                        <tbody>
                                               ...
                                               <?php 
                                                    $t->AdGV("select * from giangvien a join khoa b on a.idkhoa=b.idnganh");
                                                ?>
